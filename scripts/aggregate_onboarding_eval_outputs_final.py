...
EVAL_ROOT = ROOT / "outputs" / "eval_runs_final"
INDEX_PATH = EVAL_ROOT / "eval_case_index.json"
OUT_CSV = EVAL_ROOT / "onboarding_eval_summary_final.csv"
OUT_JSON = EVAL_ROOT / "onboarding_eval_summary_final.json"
...
def main():
    ...
    for rec in index:
        ...
        row = {
            ...
            "trial_score_share": context.get("trial_score_share", ""),
            "raw_max_cross": context.get("raw_max_cross", ""),
            "generic_question": context.get("generic_question", ""),
