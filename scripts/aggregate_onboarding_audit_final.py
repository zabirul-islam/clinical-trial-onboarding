...
AUDIT_PATH = ROOT / "data" / "processed" / "onboarding_eval_audit_final.csv"
OUT_PATH = ROOT / "outputs" / "eval_runs_final" / "onboarding_eval_audit_summary_final.txt"
...
def main():
    ...
    metrics = [
        ...
        ("Usable or partially usable outputs", "overall_usable", ["yes", "partial"]),
        ("Fully usable outputs", "overall_usable", ["yes"]),
    ]
